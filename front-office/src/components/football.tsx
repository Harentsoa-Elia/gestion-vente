...
import { Download } from "lucide-react" // Importation des icônes
import VIP from "./VIP"
...
export default function TicketGeneratorForm() {
  ...
  const [category, setCategory] = useState<string>("CHILD")
    ...
    <div className="grid gap-6">
      <style jsx global>{`
        @media print {
            ...
            * {
            ...
            grid-template-rows: repeat(8, auto); /* 8 lignes */
            gap: 0mm !important;
      ...
      <div className="no-print mb-6 bg-white p-6 rounded-lg shadow-sm border">
        <div className="flex items-center justify-between gap-10 mb-4">
          <div>
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">Générateur de Tickets Football</h2>
          </div>
              ...
              <div className="flex flex-row gap-4">
                ...
                <div className="space-y-1.5 flex-1">
                  ...
                  <Select onValueChange={setCategory} value={category}>
                    ...
                    <SelectContent>
                      <SelectItem value="CHILD">Ticket football</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
