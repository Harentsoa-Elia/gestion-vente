...
import VIP from "./VIP"
import AdulteEnfant from "./carteBille"
...
export default function TicketGeneratorForm() {
    ...
    const [category, setCategory] = useState<string>("VENTELIVE") // Valeur par défaut pour la catégorie
        ...
        <div className="grid gap-6">
            ...
            <div className="no-print mb-6 bg-white p-6 rounded-lg shadow-sm border">
                <div className="flex items-center justify-between gap-10 mb-4">
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-2">Générateur d'invitation</h2>
                    </div>
                            ...
                            <div className="flex flex-row gap-4">
                                ...
                                <div className="space-y-1.5 flex-1">
                                    ...
                                    <Select onValueChange={setCategory} value={category}>
                                        ...
                                        <SelectContent>
                                            <SelectItem value="VENTELIVE">Vente sur live</SelectItem>
                                        </SelectContent>
                                    </Select>
                                </div>
                            </div>
