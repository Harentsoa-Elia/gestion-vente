...
export default function TicketGeneratorForm() {
    ...
    return (
        ...
        @media print {
         ...
         .ticket-wrapper{
            width:140mm!important; height:45mm!important;
            margin:2mm 0!important; page-break-inside:avoid!important; break-inside:avoid!important;
         }
                            ...
                            <div className="flex flex-row gap-4">
                                ...
                                <div className="space-y-1.5 flex-1">
                                    ...
                                    <Select onValueChange={setCategory} value={category}>
                                        ...
                                        <SelectContent>
                                            <SelectItem value="ADULT">Tickets</SelectItem>
                                        </SelectContent>
                                    </Select>
                                </div>
                            </div>
