...
class ConcertBase(BaseModel):
    ...
    price_vip: float = Field(..., gt=0, description="Price of VIP tickets")
    price_adult: float = Field(..., gt=0, description="Price of adult tickets")
    price_child: float = Field(..., gt=0, description="Price of child tickets")
